...
export default class News extends Component {
    ...
    handlePrevClick = async () => {
        ...
        let url = `https://newsapi.org/v2/top-headlines?country=${this.props.country}&category=${this.props.category}&apiKey=017405e53ac34dd484db138c2f272c02&page=${this.state.page - 1}&pageSize=${this.props.pageSize}`;
